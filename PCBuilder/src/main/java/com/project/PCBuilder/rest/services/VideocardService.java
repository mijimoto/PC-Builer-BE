...
/***
	public List<VideocardDTO> findByTitle(String title) {
		...
		// List<Videocard> list = repository.findByTitle(title);
	...
	public List<VideocardDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Videocard> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}