...
/***
	public List<CpucoolerDTO> findByTitle(String title) {
		...
		// List<Cpucooler> list = repository.findByTitle(title);
	...
	public List<CpucoolerDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Cpucooler> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}