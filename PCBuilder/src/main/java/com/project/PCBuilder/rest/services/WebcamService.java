...
public class WebcamService extends GenericService<Webcam, WebcamDTO> {
	 ...
	 */
	public WebcamService(WebcamRepository repository) {
...
/***
	public List<WebcamDTO> findByTitle(String title) {
		...
		// List<Webcam> list = repository.findByTitle(title);
	...
	public List<WebcamDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Webcam> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}