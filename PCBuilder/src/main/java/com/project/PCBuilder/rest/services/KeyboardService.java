...
/***
	public List<KeyboardDTO> findByTitle(String title) {
		...
		// List<Keyboard> list = repository.findByTitle(title);
	...
	public List<KeyboardDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Keyboard> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}