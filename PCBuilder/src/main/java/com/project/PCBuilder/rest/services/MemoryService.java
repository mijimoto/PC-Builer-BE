...
/***
	public List<MemoryDTO> findByTitle(String title) {
		...
		// List<Memory> list = repository.findByTitle(title);
	...
	public List<MemoryDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Memory> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}