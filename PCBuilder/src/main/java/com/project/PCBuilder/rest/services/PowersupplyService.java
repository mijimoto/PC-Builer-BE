...
/***
	public List<PowersupplyDTO> findByTitle(String title) {
		...
		// List<Powersupply> list = repository.findByTitle(title);
	...
	public List<PowersupplyDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Powersupply> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}