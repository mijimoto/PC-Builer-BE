...
/***
	public List<MouseDTO> findByTitle(String title) {
		...
		// List<Mouse> list = repository.findByTitle(title);
	...
	public List<MouseDTO> findByTitleAndPrice(String title, BigDecimal price) {
		logger.debug("findByTitleAndPrice({}, {})", title, price);
		List<Mouse> list = repository.findByTitleContainingAndPrice(title, price);
		return entityListToDtoList(list);
	}
***/
}